import { attachment, face, moon, person, send, sun1,sun2 } from '@/assets/icons'
  ...
  <div className="container">
    ...
    <div className="row">
      <div className="col-md-12">
        ...
        <div className="card" id="chat3" style={{
          ...
          <div className="card-body" style={{height:'85vh'}}>
            ...
            <div className="row" style={{height:'100%'}}>
              <div className="col-md-6 col-lg-5 col-xl-4 mb-4 mb-md-0" style={{overflow:'scroll'}}>
              ...
              <div className="col-md-6 col-lg-7 col-xl-8" style={{
                ...
                <div className="pt-3 pe-3" data-mdb-perfect-scrollbar="true"
                  style={{position: "relative", height: "72vh",overflow:'scroll',borderBottom:"0.5px solid #f7f7f7"}}>
                ...
                >
                  <input className="form-control me-2" type="search" placeholder="Type message ..." aria-label="Search"/>
                  <div style={{
                    display: 'flex',
                    flexDirection:'row',
                    justifyContent: 'space-between',
